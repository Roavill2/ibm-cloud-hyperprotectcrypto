...
import (
	...
	util "github.com/ibm-developer/ibm-cloud-hyperprotectcrypto/golang/util"
...
func Example_bip32_KeyDerivation() {
	...
	_, err2 := cryptoClient.DeriveKey(context.Background(), deriveKeyRequestPub)
	if err2 != nil {
